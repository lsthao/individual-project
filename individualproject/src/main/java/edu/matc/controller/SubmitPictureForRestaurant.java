...
@WebServlet(
        urlPatterns = {"/submitPictureForRestaurant"}
)
/**
 * This class is used to add a picture for a specific restaurant.
 */
public class SubmitPictureForRestaurant extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = "/individualproject/byRestaurant?ID=" + restaurantID;
